...
public class TP2fermeture {
	public static void main(String []args) throws IOException
	 	{
		int R,G,B;
		double I2;
	     BufferedImage image=ImageIO.read(new File("C:/Users/ayoub/eclipse-workspace/ITNITP1/dilatation.png"));
		 ...
		 try { ImageIO.write(image2, "png", new File("fermeture2.png")); }
		 catch (Exception e) {
			 e.printStackTrace() ;
		 					 }
